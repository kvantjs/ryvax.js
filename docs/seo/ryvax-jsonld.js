    ...
    '@graph': [
      {
        ...
        '@id': 'https://github.com/kvantjs/ryvax.js#software',
        name: 'Ryvax.js',
        alternateName: 'Ryvax',
        description: 'Open-source React-first full-stack TypeScript framework for building web applications, deterministic APIs, server-rendered and statically generated pages, streaming interfaces, jobs, caching, authentication, observability, and AI agent backends.',
        applicationCategory: 'DeveloperApplication',
        applicationSubCategory: 'Full-stack web framework',
        ...
        license: 'https://github.com/kvantjs/ryvax.js/blob/main/LICENSE',
        isAccessibleForFree: true,
        offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD', url: 'https://github.com/kvantjs/ryvax.js' },
        ...
        featureList: ['File-based routing', 'React SSR and SSG', 'Client hydration', 'HTML and data streaming', 'Deterministic API routes', 'Authentication and authorization primitives', 'SQL, cache, job, storage, and metrics adapters', 'Portable Node.js deployment']
      },
      {
        '@type': 'TechArticle',
        ...
        about: { '@id': 'https://github.com/kvantjs/ryvax.js#software' },
