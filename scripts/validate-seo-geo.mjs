...
const jsonLd = fs.readFileSync('docs/seo/ryvax-jsonld.js', 'utf8');
if (!home.includes('React-first full-stack TypeScript framework') || !jsonLd.includes("'@type': 'SoftwareApplication'") || !jsonLd.includes("'@type': 'TechArticle'")) {
  throw new Error('Documentation SEO metadata and JSON-LD are missing');
}
